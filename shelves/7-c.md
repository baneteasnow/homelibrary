...
<a href="https://homelibrary.next52books.com/assets/shelves/7-C.png">{% assign books_data = site.data.list %} {% assign shelf_7c =
					books_data | where: "notes", "7-C" | size %} {{ shelf_7c }}</a>
