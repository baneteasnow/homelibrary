...
<a href="https://homelibrary.next52books.com/assets/shelves/7-D.png">{% assign books_data = site.data.list %} {% assign shelf_7d =
					books_data | where: "notes", "7-D" | size %} {{ shelf_7d }}</a>
