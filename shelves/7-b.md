...
<a href="https://homelibrary.next52books.com/assets/shelves/7-B.png">{% assign books_data = site.data.list %} {% assign shelf_7b =
					books_data | where: "notes", "7-B" | size %} {{ shelf_7b }}</a>
