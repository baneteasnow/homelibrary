...
<a href="https://homelibrary.next52books.com/assets/shelves/5-B.png">{% assign books_data = site.data.list %} {% assign shelf_5b =
					books_data | where: "notes", "5-B" | size %} {{ shelf_5b }}</a>
