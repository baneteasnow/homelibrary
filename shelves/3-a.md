...
<a href="https://homelibrary.next52books.com/assets/shelves/3-A.png">{% assign books_data = site.data.list %} {% assign shelf_3a =
					books_data | where: "notes", "3-A" | size %} {{ shelf_3a }}</a>
