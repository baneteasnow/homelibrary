...
<a href="https://homelibrary.next52books.com/assets/shelves/10-D.png">{% assign books_data = site.data.list %} {% assign shelf_10d =
					books_data | where: "notes", "10-D" | size %} {{ shelf_10d }}</a>
