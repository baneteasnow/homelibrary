...
<a href="https://homelibrary.next52books.com/assets/shelves/4-D.png">{% assign books_data = site.data.list %} {% assign shelf_4d =
					books_data | where: "notes", "4-D" | size %} {{ shelf_4d }}</a>
