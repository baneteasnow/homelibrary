...
<a href="https://homelibrary.next52books.com/assets/shelves/8-D.png">{% assign books_data = site.data.list %} {% assign shelf_8d =
					books_data | where: "notes", "8-D" | size %} {{ shelf_8d }}</a>
