...
<a href="https://homelibrary.next52books.com/assets/shelves/2-D.png">{% assign books_data = site.data.list %} {% assign shelf_2d =
					books_data | where: "notes", "2-D" | size %} {{ shelf_2d }}</a>
