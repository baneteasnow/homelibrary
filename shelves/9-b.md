...
<a href="https://homelibrary.next52books.com/assets/shelves/9-B.png">{% assign books_data = site.data.list %} {% assign shelf_9b =
					books_data | where: "notes", "9-B" | size %} {{ shelf_9b }}</a>
