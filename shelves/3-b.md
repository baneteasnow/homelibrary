...
<a href="https://homelibrary.next52books.com/assets/shelves/3-B.png">{% assign books_data = site.data.list %} {% assign shelf_3b =
					books_data | where: "notes", "3-B" | size %} {{ shelf_3b }}</a>
