...
<a href="https://homelibrary.next52books.com/assets/shelves/10-B.png">{% assign books_data = site.data.list %} {% assign shelf_10b =
					books_data | where: "notes", "10-B" | size %} {{ shelf_10b }}</a>
