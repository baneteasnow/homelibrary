...
<a href="https://homelibrary.next52books.com/assets/shelves/1-C.png">{% assign books_data = site.data.list %} {% assign shelf_1c =
					books_data | where: "notes", "1-C" | size %} {{ shelf_1c }}</a>
