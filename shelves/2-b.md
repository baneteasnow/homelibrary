...
<a href="https://homelibrary.next52books.com/assets/shelves/2-B.png">{% assign books_data = site.data.list %} {% assign shelf_2b =
					books_data | where: "notes", "2-B" | size %} {{ shelf_2b }}</a>
