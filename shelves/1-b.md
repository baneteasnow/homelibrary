...
<a href="https://homelibrary.next52books.com/assets/shelves/1-B.png">{% assign books_data = site.data.list %} {% assign shelf_1b =
					books_data | where: "notes", "1-B" | size %} {{ shelf_1b }}</a>
