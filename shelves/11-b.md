...
<a href="https://homelibrary.next52books.com/assets/shelves/11-B.png">{% assign books_data = site.data.list %} {% assign shelf_11b =
					books_data | where: "notes", "11-B" | size %} {{ shelf_11b }}</a>
