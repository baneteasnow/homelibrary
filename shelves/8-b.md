...
<a href="https://homelibrary.next52books.com/assets/shelves/8-B.png">{% assign books_data = site.data.list %} {% assign shelf_8b =
					books_data | where: "notes", "8-B" | size %} {{ shelf_8b }}</a>
