...
<a href="https://homelibrary.next52books.com/assets/shelves/12-D.png">{% assign books_data = site.data.list %} {% assign shelf_12d =
					books_data | where: "notes", "12-D" | size %} {{ shelf_12d }}</a>
