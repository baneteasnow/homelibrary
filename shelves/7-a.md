...
<a href="https://homelibrary.next52books.com/assets/shelves/7-A.png">{% assign books_data = site.data.list %} {% assign shelf_7a =
					books_data | where: "notes", "7-A" | size %} {{ shelf_7a }}</a>
