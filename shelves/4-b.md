...
<a href="https://homelibrary.next52books.com/assets/shelves/4-B.png">{% assign books_data = site.data.list %} {% assign shelf_4b =
					books_data | where: "notes", "4-B" | size %} {{ shelf_4b }}</a>
