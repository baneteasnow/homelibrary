...
<a href="https://homelibrary.next52books.com/assets/shelves/6-A.png">{% assign books_data = site.data.list %} {% assign shelf_6a =
					books_data | where: "notes", "6-A" | size %} {{ shelf_6a }}</a>
