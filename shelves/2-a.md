...
<a href="https://homelibrary.next52books.com/assets/shelves/2-A.png">{% assign books_data = site.data.list %} {% assign shelf_2a =
					books_data | where: "notes", "2-A" | size %} {{ shelf_2a }}</a>
