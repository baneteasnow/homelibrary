...
<a href="https://homelibrary.next52books.com/assets/shelves/9-C.png">{% assign books_data = site.data.list %} {% assign shelf_9c =
					books_data | where: "notes", "9-C" | size %} {{ shelf_9c }}</a>
