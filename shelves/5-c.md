...
<a href="https://homelibrary.next52books.com/assets/shelves/5-C.png">{% assign books_data = site.data.list %} {% assign shelf_5c =
					books_data | where: "notes", "5-C" | size %} {{ shelf_5c }}</a>
