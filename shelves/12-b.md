...
<a href="https://homelibrary.next52books.com/assets/shelves/12-B.png">{% assign books_data = site.data.list %} {% assign shelf_12b =
					books_data | where: "notes", "12-B" | size %} {{ shelf_12b }}</a>
