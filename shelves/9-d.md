...
<a href="https://homelibrary.next52books.com/assets/shelves/9-D.png">{% assign books_data = site.data.list %} {% assign shelf_9d =
					books_data | where: "notes", "9-D" | size %} {{ shelf_9d }}</a>
