...
<a href="https://homelibrary.next52books.com/assets/shelves/2-C.png">{% assign books_data = site.data.list %} {% assign shelf_2c =
					books_data | where: "notes", "2-C" | size %} {{ shelf_2c }}</a>
