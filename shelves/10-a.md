...
<a href="https://homelibrary.next52books.com/assets/shelves/10-A.png">{% assign books_data = site.data.list %} {% assign shelf_10a =
					books_data | where: "notes", "10-A" | size %} {{ shelf_10a }}</a>
