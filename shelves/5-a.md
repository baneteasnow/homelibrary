...
<a href="https://homelibrary.next52books.com/assets/shelves/5-A.png">{% assign books_data = site.data.list %} {% assign shelf_5a =
					books_data | where: "notes", "5-A" | size %} {{ shelf_5a }}</a>
