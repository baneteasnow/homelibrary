...
<a href="https://homelibrary.next52books.com/assets/shelves/6-C.png">{% assign books_data = site.data.list %} {% assign shelf_6c =
					books_data | where: "notes", "6-C" | size %} {{ shelf_6c }}</a>
