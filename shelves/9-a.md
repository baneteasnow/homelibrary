...
<a href="https://homelibrary.next52books.com/assets/shelves/9-A.png">{% assign books_data = site.data.list %} {% assign shelf_9a =
					books_data | where: "notes", "9-A" | size %} {{ shelf_9a }}</a>
