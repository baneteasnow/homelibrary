...
<a href="https://homelibrary.next52books.com/assets/shelves/8-C.png">{% assign books_data = site.data.list %} {% assign shelf_8c =
					books_data | where: "notes", "8-C" | size %} {{ shelf_8c }}</a>
