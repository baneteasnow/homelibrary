...
<a href="https://homelibrary.next52books.com/assets/shelves/3-D.png">{% assign books_data = site.data.list %} {% assign shelf_3d =
					books_data | where: "notes", "3-D" | size %} {{ shelf_3d }}</a>
