...
<a href="https://homelibrary.next52books.com/assets/shelves/10-C.png">{% assign books_data = site.data.list %} {% assign shelf_10c =
					books_data | where: "notes", "10-C" | size %} {{ shelf_10c }}</a>
