...
<a href="https://homelibrary.next52books.com/assets/shelves/3-C.png">{% assign books_data = site.data.list %} {% assign shelf_3c =
					books_data | where: "notes", "3-C" | size %} {{ shelf_3c }}</a>
