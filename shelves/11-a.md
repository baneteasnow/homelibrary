...
<a href="https://homelibrary.next52books.com/assets/shelves/11-A.png">{% assign books_data = site.data.list %} {% assign shelf_11a =
					books_data | where: "notes", "11-A" | size %} {{ shelf_11a }}</a>
