...
<a href="https://homelibrary.next52books.com/assets/shelves/11-D.png">{% assign books_data = site.data.list %} {% assign shelf_11d =
					books_data | where: "notes", "11-D" | size %} {{ shelf_11d }}</a>
