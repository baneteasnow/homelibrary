...
<a href="https://homelibrary.next52books.com/assets/shelves/12-C.png">{% assign books_data = site.data.list %} {% assign shelf_12c =
					books_data | where: "notes", "12-C" | size %} {{ shelf_12c }}</a>
