...
<a href="https://homelibrary.next52books.com/assets/shelves/8-A.png">{% assign books_data = site.data.list %} {% assign shelf_8a =
					books_data | where: "notes", "8-A" | size %} {{ shelf_8a }}</a>
