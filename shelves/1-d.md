...
<a href="https://homelibrary.next52books.com/assets/shelves/1-D.png">{% assign books_data = site.data.list %} {% assign shelf_1d =
					books_data | where: "notes", "1-D" | size %} {{ shelf_1d }}</a>
