...
<a href="https://homelibrary.next52books.com/assets/shelves/5-D.png">{% assign books_data = site.data.list %} {% assign shelf_5d =
					books_data | where: "notes", "5-D" | size %} {{ shelf_5d }}</a>
