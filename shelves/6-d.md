...
<a href="https://homelibrary.next52books.com/assets/shelves/6-D.png">{% assign books_data = site.data.list %} {% assign shelf_6d =
					books_data | where: "notes", "6-D" | size %} {{ shelf_6d }}</a>
