...
<a href="https://homelibrary.next52books.com/assets/shelves/6-B.png">{% assign books_data = site.data.list %} {% assign shelf_6b =
					books_data | where: "notes", "6-B" | size %} {{ shelf_6b }}</a>
