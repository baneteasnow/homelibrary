...
<a href="https://homelibrary.next52books.com/assets/shelves/11-C.png">{% assign books_data = site.data.list %} {% assign shelf_11c =
					books_data | where: "notes", "11-C" | size %} {{ shelf_11c }}</a>
