...
<a href="https://homelibrary.next52books.com/assets/shelves/12-A.png">{% assign books_data = site.data.list %} {% assign shelf_12a =
					books_data | where: "notes", "12-A" | size %} {{ shelf_12a }}</a>
