...
<a href="https://homelibrary.next52books.com/assets/shelves/4-A.png">{% assign books_data = site.data.list %} {% assign shelf_4a =
					books_data | where: "notes", "4-A" | size %} {{ shelf_4a }}</a>
